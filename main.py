...
# ===========================
# PLACEHOLDERS PARA PRIORIDADES (Para seus colegas)
# ===========================
def prioridade_non_preemptive():
    print("\n=== PRIORIDADE NON-PREEMPTIVE (EM DESENVOLVIMENTO) ===")
    print("Espaço reservado para o Integrante 1.")

def prioridade_preemptive():
    print("\n=== PRIORIDADE PREEMPTIVE (EM DESENVOLVIMENTO) ===")
    print("Espaço reservado para o Integrante 2.")
...
while True:
    ...
    print("6 - M/M/s/N")
    print("7 - M/G/1")
    print("8 - Prioridade Non-Preemptive")
    print("9 - Prioridade Preemptive")
    print("0 - Sair")
    ...
    if opcao == "1":
        ...
        prioridade_non_preemptive()

    elif opcao == "9":
        prioridade_preemptive()
